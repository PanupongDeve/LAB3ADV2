...
set val(ifqlen)       50                        
set val(nn)           2   ;#number of node                        
set val(rp)           AODV  ;# Routing Protocal               
set val(x) 	      700   ;# X dimension of the topography พื้นที่ต้องการจำลอง               
...
set tracefile [open simple1-2.tr w]
$ns_ use-newtrace
$ns_ trace-all $tracefile

set namfile [open simple1-2.nam w]
